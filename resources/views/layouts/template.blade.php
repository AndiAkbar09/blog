...
<head>
    ...
    <!-- Styles -->
    <link href="{{ asset('css/_youtube.css') }}" rel="stylesheet">
</head>
 <body>
    <div id="app">
    <nav class="navbar fixed-top bg-white flex-md-nowrap">
      
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#"><svg viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope ytd-topbar-logo-renderer" style="pointer-events: none; display: block; width: 50%; height: 50%;"><g viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" class="style-scope ytd-topbar-logo-renderer">
    ...
    <input class="form-control form-control-dark" type="text" placeholder="Search" aria-label="Search">
        <ul class="navbar-nav px-3">
            <div class="d-flex justify-content-center">
                ...
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon" width="24" height="24" style="pointer-events: none; display: block; "><g class="style-scope yt-icon">
